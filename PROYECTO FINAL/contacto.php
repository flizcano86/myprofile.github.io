...
$db = mysqli_select_db($conexion, $basededatos) or die ("Error conexion al conectarse a la Base de datos");
 ...
 //sentencia sql
 $sql="INSERT INTO contacto VALUES ('$nombre','$correo','$telefono','$mensaje')"; //manda a traer los valores de '$nombre','$correo','$mensaje'
 ...
 $ejecutar=mysqli_query($conexion, $sql);
  ...
  if(!$ejecutar){
    ...
    echo"datos guardado correctamente <br><a href='contacto.html'>volver</a>"; //si todo sale bien mandanos este mensaje
}
